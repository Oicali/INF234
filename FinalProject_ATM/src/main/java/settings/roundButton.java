...
public class roundButton extends JButton {
    ...
    private Color temp1;
    private Color temp2;
    public Color fColor1 = (Color.WHITE);//change default font color
    public Color fColor2 = new Color (217,217,217);
    public boolean isClicked = false;

    //method transfer
    private onClickInterface roundButtonClick;

    public void setClickAction(onClickInterface listener) {
        this.roundButtonClick = listener;
    }
    ...
    public roundButton(String text, Color color1a, Color color2a, Color color1b, Color color2b) {
        ...
        this.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(MouseEvent e) {
                setForeground(fColor2); // On Click Color
                if (roundButtonClick != null) {
                    roundButtonClick.onClick();
                }
            }
