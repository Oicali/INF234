...
public class printPDFReceipts extends frames {
    ...
    public static void printReceipt(String transactionType, String accountType, String refNo, String date, double amount, double balance) throws FileNotFoundException, MalformedURLException, IOException {
        ...
        document.add(new Paragraph("Your Future Matters!").setTextAlignment(TextAlignment.CENTER).setFontSize(10).setFont(font));
    ...
    public static void printBalance(String accountType, String date) throws FileNotFoundException, MalformedURLException, IOException {
        ...
        Paragraph p1 = new Paragraph("Your Future Matters!").setTextAlignment(TextAlignment.CENTER).setFontSize(10).setFont(font);
        p1.setFixedPosition(-25, 303, 400);
        document.add(p1);
    ...
    public static void printHistory(String pass) throws FileNotFoundException, MalformedURLException, IOException {
        // Encrypt the document
        PdfWriter writer = new PdfWriter(path3, new WriterProperties().setStandardEncryption(pass.getBytes(), pass.getBytes(),
                EncryptionConstants.ALLOW_PRINTING | EncryptionConstants.ALLOW_MODIFY_CONTENTS, EncryptionConstants.ENCRYPTION_AES_128));
        PdfDocument pdf = new PdfDocument(writer);
        PageSize ps = new PageSize(350, 475);
        Document document = new Document(pdf, ps);
